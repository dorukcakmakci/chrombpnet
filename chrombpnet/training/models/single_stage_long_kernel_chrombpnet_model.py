...
def bpnet_model(filters, n_dil_layers, sequence_len, out_pred_len):
    ...
    conv1_kernel_size=50
    profile_kernel_size=46
...
def getModelGivenModelOptionsAndWeightInits(args, model_params):   
    ...
    # If you want to keep the same layer names for consistency:
    profile_out = Lambda(lambda x: x, name="logits_profile_predictions")(output_wo_bias[0])
    count_out = Lambda(lambda x: x, name="logcount_predictions")(output_wo_bias[1])
